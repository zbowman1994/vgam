...
CREATE TABLE IF NOT EXISTS `ics199grp00`.`customer` (
  ...
  PRIMARY KEY (`cust_id`, `session_id`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `ics199grp00`.`cart` (
  ...
  `customer_session_id` INT NOT NULL,
  INDEX `fk_cart_products1_idx` (`products_product_id` ASC),
  PRIMARY KEY (`cart_id`),
  INDEX `fk_cart_customer1_idx` (`customer_cust_id` ASC, `customer_session_id` ASC),
  UNIQUE INDEX `products_product_id_UNIQUE` (`products_product_id` ASC),
  ...
  CONSTRAINT `fk_cart_customer1`
    FOREIGN KEY (`customer_cust_id` , `customer_session_id`)
    REFERENCES `ics199grp00`.`customer` (`cust_id` , `session_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
